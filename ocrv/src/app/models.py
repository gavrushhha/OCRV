...
class Trains(Id):
    ...
    id_route = models.ForeignKey(Routes, verbose_name=_('routes'), on_delete=models.CASCADE, related_name='routes')
...
class Goods_and_services(Id):
    ...
    class Meta:
        # constraints = [models.UniqueConstraint(fields=["name"], name="unique_train")]
        db_table = "content\".\"goods_and_services"
...
class Purch_tickets(Id):
    ...
    id_train = models.ForeignKey(Trains, verbose_name=_('train'), on_delete=models.CASCADE, related_name='train')
    id_passengers = models.ForeignKey(Passengers, verbose_name=_('passengers'), on_delete=models.CASCADE, related_name='passengers')
    ...
    class Meta:
        # constraints = [models.UniqueConstraint(fields=["name"], name="unique_train")]
        db_table = "content\".\"purch_tickets"
        verbose_name = _('purch_tickets')
        verbose_name_plural = _('purch_tickets')

class Purch_goods_services(Id):
    id_ticket = models.ForeignKey(Purch_tickets, verbose_name=_('ticket'), on_delete=models.CASCADE, related_name='ticket')
    id_gs = models.ForeignKey(Goods_and_services, verbose_name=_('gs'), on_delete=models.CASCADE, related_name='gs')
    ...
    class Meta:
        # constraints = [models.UniqueConstraint(fields=["name"], name="unique_train")]
        db_table = "content\".\"purch_goods_services"
